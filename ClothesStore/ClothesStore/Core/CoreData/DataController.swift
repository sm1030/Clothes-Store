...
class DataController {
    ...
    private lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "ClothesStore", withExtension: "momd")!
    ...
    private lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("ClothesStore.sqlite")
    ...
    static func getItem<T : NSManagedObject>(forPredicate predicate: NSPredicate, addItemIfNeeded: Bool = false) -> T? {
        do {
            ...
            if let fetchResults = try DataController.sharedInstance.managedObjectContext.fetch(fetchRequest) as? [T] {
        ...
        if addItemIfNeeded {
            let item = NSEntityDescription.insertNewObject(forEntityName: String(describing: T.self), into: DataController.sharedInstance.managedObjectContext) as? T
            return item
        } else {
            return nil
        }
